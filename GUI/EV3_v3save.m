    ...
    methods
        ...
        function SendReceiveEV3Data(obj, event)
            ...
            if (obj.Connected)
                ...
                obj.UpdateCommand(); % something wrong gere
                ...
                case Task.Park
                     switch(obj.TaskState)
                        ...
                        case 2
                         ...
                         case 3
                             switch (obj.myParkingSpot) % I don't understand what this is for.  Oh this releases the parking spot once at entranceway
                                 case 1
